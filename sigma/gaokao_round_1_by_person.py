...
if __name__ == "__main__":
    ...
    account_list = AccountMgr.get_account_list(root_dir+"/sigma/gaokao_round_1_by_person.csv")
    student_service = StudentService()
    sigma_service = SigmaService()
    for config_info in account_list:
        select_period_name_list = config_info[1].split("#")
        ...
        student_name,student_section = student_info[2],student_info[6]
